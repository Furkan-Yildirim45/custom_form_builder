...
const LoginPage: React.FC = () => {
  ...
  const { setUser } = useUserContext(); // Kullanıcı bilgisini ayarlamak için context
  ...
  const handleLogin = () => {
    ...
    if (email === "admin@gmail.com" && password === "admin123") {
      setUser({ email, role: "Admin" }); // Kullanıcı bilgisini context'e kaydet
      router.push("/pages/home"); // Ana sayfaya yönlendir
